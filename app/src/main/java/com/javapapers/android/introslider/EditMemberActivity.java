...
public class EditMemberActivity extends AppCompatActivity {
    ...
    String useremail, username, userphone,useraddress,userrelation, img ="", cur_img="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null ){
            ...
            userrelation = bundle.getString("userrelation");
            ...
            textInputRelation.setText(userrelation);
        }
        ...
        profilePicture.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(EditMemberActivity.this, new String[] {
    ...
    public void  onBackPressed(String name, String email, String phone, String address, String relation ,String img)
    {
        super.onBackPressed();
...
//                    txt_image_path.setText(selectedImagePath);
    ...
    private boolean validateRelation() {
        String RelationInput = textInputRelation.getText().toString().trim();

        if (RelationInput.isEmpty()) {
            textInputRelation.setError("Field can't be empty");
            return false;
        }
        else {
            textInputRelation.setError(null);
            return true;
        }
    }
    public void updateMember(){
        Map<String, String> jsonParams = new HashMap<String, String>();
        jsonParams.put("mem_email",useremail);
        ...
        String url = "http://192.168.43.176:5000/update/member" ;
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        if (result.toString().equals("success"))
                        {
                            ...
                            onBackPressed(textInputname.getText().toString(), textInputEmail.getText().toString(),textInputphone.getText().toString(),textInputAddress.getText().toString(),textInputRelation.getText().toString(), cur_img);
